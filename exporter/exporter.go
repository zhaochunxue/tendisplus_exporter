...
func NewRedisExporter(redisURI string, opts Options) (*Exporter, error) {
	...
	e := &Exporter{
		...
		// Gauge是最简单的度量类型，只有一个简单的返回值，可增可减
		metricMapGauges: map[string]string{
			// # Server
			...
			"total_commands_cost(ns)":                  "total_commands_cost_ns",
			"total_commands_workpool_queue_cost(ns)":   "total_commands_workpool_queue_cost_ns",
			"total_commands_workpool_execute_cost(ns)": "total_commands_workpool_execute_cost_ns",
			"total_commands_send_packet_cost(ns)":      "total_commands_send_packet_cost_ns",
			"total_commands_execute_cost(ns)":          "total_commands_execute_cost_ns",
			"avg_commands_cost(ns)":                    "avg_commands_cost_ns",
			"avg_commands_workpool_queue_cost(ns)":     "avg_commands_workpool_queue_cost_ns",
			"avg_commands_workpool_execute_cost(ns)":   "avg_commands_workpool_execute_cost_ns",
			"avg_commands_send_packet_cost(ns)":        "avg_commands_send_packet_cost_ns",
			"avg_commands_execute_cost(ns)":            "avg_commands_execute_cost_ns",
			"commands_in_queue":                        "commands_in_queue",
			"commands_executed_in_workpool":            "commands_executed_in_workpool",
			"total_stricky_packets":                    "total_stricky_packets",
			"total_invalid_packets":                    "total_invalid_packets",
			"keyspace_wrong_versionep":                 "keyspace_wrong_versionep",
			"scheduleNum":                              "schedule_num",
			...
			// # Dataset
			"rocksdb.kvstore-count":                     "rocksdb_kvstore_count",
			"rocksdb.total-sst-files-size":              "rocksdb_total_sst_files_size",
			"rocksdb.live-sst-files-size":               "rocksdb_live_sst_files_size",
			"rocksdb.estimate-live-data-size":           "rocksdb_estimate_live_data_size",
			"rocksdb.estimate-num-keys":                 "rocksdb_estimate_num_keys",
			"rocksdb.total-memory":                      "rocksdb_total_memory",
			"rocksdb.cur-size-all-mem-tables":           "rocksdb_cur_size_all_mem_tables",
			"rocksdb.estimate-table-readers-mem":        "rocksdb_estimate_table_readers_mem",
			"rocksdb.blockcache.capacity":               "rocksdb_blockcache_capacity",
			"rocksdb.blockcache.usage":                  "rocksdb_blockcache_usage",
			"rocksdb.blockcache.pinnedusage":            "rocksdb_blockcache_pinnedusage",
			"rocksdb.number.iter.skip":                  "rocksdb_number_iter_skip",
		...
		// Counter就是一个计数器，表示一种累积型指标，该指标只能单调递增或在重新启动时重置为零
		metricMapCounters: map[string]string{
